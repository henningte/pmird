...
Go to [the project's GitHub repository](https://github.com/henningte/pmird) and download the zip folder [data_template.zip](https://github.com/henningte/pmird/data_template.zip). This folder contains a set of csv/docx templates where you can enter your data and the data policy agreement for pmird. A detailed manual to fill in the data is provided below.
...
1. Go to [the project's GitHub repository](https://github.com/henningte/pmird) and download the zip folder [data_template.zip](https://github.com/henningte/pmird/data_template.zip). This folder contains a detailed manual and a set of csv/docx templates where you can enter your data.
