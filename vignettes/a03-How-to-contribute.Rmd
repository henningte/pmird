...
Go to [the project's GitHub repository](https://github.com/henningte/pmird) and download the zip folder [data.template.zip](https://github.com/henningte/pmird/data.template.zip). This folder contains a set of csv/docx templates where you can enter your data and the data policy agreement for pmird. A detailed manual to fill in the data is provided below.

If you have questions, don't hesitate to contact me!

### How to contribute to the data paper?

If you submit your data before January 31, 2021, you and all other co-authors of the submitted data set will become co-authors not only of the data compendium, but also of the corresponding data paper.
...
1. Go to [the project's GitHub repository](https://github.com/henningte/pmird) and download the zip folder [data.template.zip](https://github.com/henningte/pmird/data.template.zip). This folder contains a detailed manual and a set of csv/docx templates where you can enter your data.
