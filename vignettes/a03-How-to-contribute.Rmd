...
For the data paper, there is a deadline, meaning that only submissions before ... will be considered.
...
Go to [the project's GitHub repository](https://github.com/henningte/pmird) and download the zip folder [](). This folder contains a detailed manual and a set of csv/docx templates where you can enter your data.
...
Fill in the data. Please include as much information as possible, especially on the methods used to collect and process the data. You also have to make sure that all co-authors agree in sharing the data and to become co-author of the data package (and data paper if you submit before ...).

Make sure to also fill the data policy agreement. I will contact any co-authors to make sure they also fill in the agreement.

If you have any data that does not fit in the form (for example because there is no field), contact me and we can discuss how to incorporate the data.

Finally, put all the filled templates into a zip archive and send it to henning.teickner@uni-muenster.de. I will notify you that your data has been integrated into the data compendium and provide you regular updates on the process. I will also contact you in case of any questions.

If you have further questions, don't hesitate to contact me!

### How to contribute to the data paper?

If you submit your data before ..., you and all other co-authors of the submitted data set will become co-authors not only of the data compendium, but also of the corresponding data paper.
...
I will draft the paper and consider your data description during this process. Finally, I will request you to review the manuscript before submission. You need to reply early enough (within four weeks) to this, else it would be unethical to include you as co-author.

### Step-by-step manual

1. Go to [the project's GitHub repository](https://github.com/henningte/pmird) and download the zip folder [](). This folder contains a detailed manual and a set of csv/docx templates where you can enter your data.

2. Fill in the data policy agreement with your personal data. This is needed since we store your name and affiliation to generate the author list for the data compendium and to contact you.

3. Fill in the data! For the csv files, there is a detailed description of what the fields mean, what to enter and which measurement units to use: ___ todo: data dictionary.
...
4. Put all files created or collected during steps 3.a to 3.g into a zip archive and send it to henning.teickner@uni-muenster.de. That's it!
